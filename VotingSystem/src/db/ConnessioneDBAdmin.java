...
public class ConnessioneDBAdmin {
	...
	public static boolean getConnection(String nome_utente, String passwd_utente) throws Exception {
		try {
			//Connessione al db con credenziali fissate
			...
			String query = "SELECT * FROM Persona where nome_utente ='"+nome_utente+"'"+" and password ='"+passwd_utente+"'";
			...
			if(counter==false) {
				System.out.println("NON identificato!");
				return false;
			}
		} catch(Exception e) {
