		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (textField.getText().isEmpty() || passwordField.getText().isEmpty()) {
					...
					System.out.println("Errore: credenziali amministratore NON inserite!");
				}
				else if (!textField.getText().equals("local") || !passwordField.getText().equals("local")) {
					textField.setText("");
					passwordField.setText("");
					JOptionPane.showMessageDialog(null, "Attenzione: username o password errati!", "Errore", JOptionPane.ERROR_MESSAGE);
					...
					admin.setNumeroSezioneElettorale(1);
					admin.setComuneSezioneElettorale("MODENA (MO)");
					admin.setPresidente(new Elettore("MARIO", "ROSSI"));
					admin.setSegretario(new Elettore("MARIO", "ROSSI"));
					admin.setScrutatore(new Elettore("MARIO", "ROSSI"));
